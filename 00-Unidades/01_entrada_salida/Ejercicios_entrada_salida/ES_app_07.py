...
class App(customtkinter.CTk):
    ...
    def btn_restar_on_click(self):
        ...
        alert("resultado","El resultado de la resta es: {}".format(resta))
    ...
    def btn_multiplicar_on_click(self):
        ...
        multiplicación = (valor_a * valor_b)

        alert("resultado","El resultado de la multiplicacion es: {}".format(multiplicación))
    ...
    def btn_dividir_on_click(self):
        ...
        alert("resultado","El resultado de la division es: {}".format(division))
