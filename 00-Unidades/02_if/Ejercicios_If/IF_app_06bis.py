...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        if altura < 160:
            alert("mensaje", "Posicion del jugador; Base")
        else:
            if altura > 159 and altura < 180:
                alert("mensaje", "Posicion del jugador; Escolta")
            else:
                if altura > 179 and altura < 200:
                    alert("mensaje", "Posicion del jugador; Alero")
                else:
                    alert("mensaje", "Posicion del jugador; Ala-Pívot o Pívot")
